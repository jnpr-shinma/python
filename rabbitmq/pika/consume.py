...
parameters =  pika.ConnectionParameters('10.102.93.212', credentials=credentials)
connection = pika.BlockingConnection(parameters)

channel = connection.channel()
channel.exchange_declare(exchange="vnc_config.object-update", exchange_type="fanout", passive=False, durable=True, auto_delete=False)
